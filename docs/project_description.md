...
| fsspec                                            | Filesystem abstraction available to the source-data readers (Xarray/Zarr). Not the managed-store backend — managed GeoZarr goes through Icechunk (see 8.2).                                   |
